...
web3 = Web3(provider=HTTPProvider("https://:89cf6e5e254b4f86b29b9ff87e62fd71@ropsten.infura.io/v3/c0b27c82e422486aac6205305d8ef240"))
...
def deploy():
    ...
    tx_link = f"https://ropsten.etherscan.io/tx/{tx_hash}"
