...
def main():
    ...
    account5 = {'Address': 'account5', 'Weight': 999}
    ...
    blockchain5 = Blockchain(GENESIS_BLOCK5, account5)

    blockchain5.generate_new_block(52)

    clients = [blockchain, blockchain2, blockchain3, blockchain5]

    blockchain.add_new_node(blockchain2)
    blockchain.add_new_node(blockchain3)
    blockchain.add_new_node(blockchain5)

    blockchain2.add_new_node(blockchain)
    blockchain2.add_new_node(blockchain3)
    blockchain2.add_new_node(blockchain5)

    blockchain.get_blocks_from_nodes()
    blockchain2.get_blocks_from_nodes()

    blockchain3.add_new_node(blockchain5)
    ...
    blockchain4.add_new_node(blockchain5)
    blockchain4.pos()
